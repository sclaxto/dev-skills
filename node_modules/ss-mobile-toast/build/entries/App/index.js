...
// 解决外部引用时的传参问题
var AppWrap = /*#__PURE__*/function (_Component) {
  _inherits(AppWrap, _Component);

  var _super = _createSuper(AppWrap);
  ...
  function AppWrap(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleUpdateState", function (props) {
    ...
    _this.dvaInstance = (0, _dva.default)( /*#__PURE__*/_react.default.createElement(_App.default, null));
